          ...
          return (
            <div
              ...
              className={`rounded-xl border p-4 backdrop-blur-md transition-all duration-200 ${
                isCompleted
                  ? "border-cyan-500/30 bg-slate-900/60 shadow-lg shadow-cyan-950/20 hover:border-cyan-500/60"
                  : isFailed
            ...
            >
              <div className="mb-2 flex items-center justify-between">
                <span className="rounded-md border border-cyan-500/20 bg-slate-800 px-2 py-0.5 font-mono text-xs text-cyan-400">
