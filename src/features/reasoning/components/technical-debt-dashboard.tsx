  ...
  return (
    <div className="w-full rounded-xl border border-slate-200 bg-white p-6 font-sans text-slate-900 shadow-2xl">
      ...
      <div className="flex flex-col justify-between gap-4 border-b border-slate-200 pb-6 md:flex-row md:items-center">
        ...
        <div className="flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-100 px-4 py-2.5">
          <div>
      ...
      <div className="mt-6 space-y-4">
        {filteredItems.map((item) => (
          <div
            ...
            className="group cursor-pointer rounded-xl border border-slate-200 bg-slate-100 p-5 shadow-lg transition-all hover:border-slate-200 hover:bg-slate-100"
          >
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-2">
                ...
                <h3 className="flex items-center gap-2 text-sm font-semibold text-slate-900 transition-colors group-hover:text-indigo-300">
                  {item.title}
