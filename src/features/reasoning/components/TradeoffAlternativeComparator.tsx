...
export function TradeoffAlternativeComparator({ tradeoffs, alternatives }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="mb-1 text-lg font-semibold text-slate-900">Generated Design Alternatives</h3>
          ...
          {alternatives.map((alt) => {
            ...
            return (
              ...
              >
                ...
                <p className="mb-3 text-xs text-slate-700">{alt.description}</p>
      ...
      {/* Tradeoff Matrix */}
      <div>
        <h3 className="mb-1 text-lg font-semibold text-slate-900">Tradeoff Evaluation Vectors</h3>
        ...
        <div className="space-y-3">
          {tradeoffs.map((t) => (
            ...
            >
              ...
              <p className="leading-relaxed text-slate-700">{t.comparisonDetails}</p>
            </div>
          ))}
        </div>
      </div>
