...
export function TradeoffAlternativeComparator({ tradeoffs, alternatives }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="mb-1 text-lg font-semibold text-slate-100">Generated Design Alternatives</h3>
            ...
            return (
              ...
              >
                <div className="mb-2 flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-100">{alt.name}</span>
                  <span
                ...
                <p className="mb-3 text-xs text-slate-300">{alt.description}</p>

                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="rounded-lg border border-emerald-900/30 bg-slate-950/80 p-2.5">
                  ...
                  <div className="rounded-lg border border-rose-900/30 bg-slate-950/80 p-2.5">
      ...
      {/* Tradeoff Matrix */}
      <div>
        <h3 className="mb-1 text-lg font-semibold text-slate-100">Tradeoff Evaluation Vectors</h3>
        ...
        <div className="space-y-3">
          {tradeoffs.map((t) => (
            <div
              ...
              className="rounded-xl border border-slate-800 bg-slate-900/60 p-3.5 text-xs"
            >
              ...
              <p className="leading-relaxed text-slate-300">{t.comparisonDetails}</p>
            </div>
          ))}
        </div>
      </div>
