    ...
    <div className="space-y-4">
      ...
      <div className="overflow-x-auto rounded-xl border border-slate-800 bg-slate-950/60">
        <table className="w-full text-left text-xs text-slate-300">
          <thead className="border-b border-slate-800 bg-slate-900/80 font-mono text-[10px] tracking-wider text-slate-400 uppercase">
            <tr>
          ...
          <tbody className="divide-y divide-slate-800/60">
            {weights.map((w) => (
              <tr key={w.evidenceId} className="transition-colors hover:bg-slate-900/50">
                <td className="px-4 py-3 font-medium text-slate-100">
                  ...
                  <div className="mt-1 text-[11px] leading-relaxed text-slate-400 italic">
                    &quot;{w.weightExplanation}&quot;
                  </div>
                </td>
