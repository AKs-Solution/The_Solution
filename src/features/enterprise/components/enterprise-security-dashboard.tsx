    ...
    <div className="w-full space-y-6 rounded-xl border border-slate-200 bg-white p-6 font-sans text-slate-900 shadow-2xl">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <div className="space-y-1 rounded-xl border border-slate-200 bg-slate-100 p-4">
          <div className="text-xs font-medium text-slate-500">Tenant Isolation</div>
        ...
        <div className="space-y-1 rounded-xl border border-slate-200 bg-slate-100 p-4">
          <div className="text-xs font-medium text-slate-500">P99 API Latency</div>
        ...
        <div className="space-y-1 rounded-xl border border-slate-200 bg-slate-100 p-4">
          <div className="text-xs font-medium text-slate-500">Knowledge Graph Nodes</div>
        ...
        <div className="space-y-1 rounded-xl border border-slate-200 bg-slate-100 p-4">
          <div className="text-xs font-medium text-slate-500">Audit Trail Integrity</div>
          <div className="flex items-center gap-2 text-xl font-bold text-emerald-400">
      ...
      <div className="space-y-3 pt-2">
        ...
        <div className="grid grid-cols-1 gap-3 text-xs md:grid-cols-2">
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 p-3">
          ...
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-100 p-3">
            <span className="font-medium text-slate-700">Fine-Grained Graph & Document RBAC</span>
            <span className="rounded border border-emerald-500/30 bg-emerald-500/20 px-2 py-0.5 font-mono text-[11px] text-emerald-400">
              VERIFIED
            </span>
          </div>
