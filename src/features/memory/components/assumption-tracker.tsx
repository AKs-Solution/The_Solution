          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-1">
                ...
                <h3 className="mt-2 text-sm font-semibold text-slate-900">{asm.statement}</h3>
                <p className="mt-1 text-xs text-slate-500">
                  <strong className="text-slate-700">Justification:</strong> {asm.justification}
                </p>
            ...
            {selectedId === asm.id && (
              <div className="mt-4 space-y-3 border-t border-slate-200 pt-4">
                <textarea
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-white p-2.5 text-xs text-slate-900 focus:border-rose-500 focus:outline-none"
                  rows={2}
                />
