...
const TIERS = [
  {
    ...
    points: [
      "Single-project CAD verification on the public aerospace corpus",
      "Local GD&T rule checks against physical invariants",
      "Community support via the product help center",
  ...
  },
  {
    ...
    points: [
      "Fixed annual or monthly seat pricing",
      "Multi-system failure graphs across programs",
      "Continuous Decision Sentinel surveillance",
      "Full AS9100 export dossiers and SHA-256 evidence chains",
    ],
