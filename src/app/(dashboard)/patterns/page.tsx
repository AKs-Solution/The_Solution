                ...
                <CardContent className="flex flex-col gap-6">
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col">
                      <div className="flex items-center gap-3">
                        <h3 className="text-lg font-bold text-slate-900">{p.partType}</h3>
                      ...
                      <span className="mt-1 text-xs text-slate-500">
                        Material: <span className="font-semibold text-slate-700">{p.material}</span>{" "}
                    ...
                    <Button
                      ...
                      className="h-9 bg-indigo-600 px-4 text-xs font-semibold text-slate-900 hover:bg-indigo-700"
                    >
                      {copiedId === p.id ? (
                  ...
                  <div className="grid grid-cols-1 gap-4 text-xs md:grid-cols-4">
                    <div className="flex flex-col gap-1 rounded-xl border border-slate-200 bg-slate-50 p-3">
                      ...
                      <span className="font-semibold text-slate-700">{p.spanDimensions}</span>
                    </div>
                    ...
                    <div className="flex flex-col gap-1 rounded-xl border border-slate-200 bg-slate-50 p-3">
                      ...
                      <span className="font-semibold text-slate-700">{p.toleranceClass}</span>
                    </div>
                  ...
                  <div className="flex flex-col gap-1 rounded-xl border border-indigo-500/20 bg-indigo-500/5 p-4 text-xs">
                    ...
                    <p className="leading-relaxed text-slate-600">{p.lessonsLearned}</p>
                  </div>
                </CardContent>
              </Card>
            ))
