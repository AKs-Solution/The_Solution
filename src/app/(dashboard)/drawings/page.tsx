  ...
  return (
    <PageContainer className="min-h-screen bg-zinc-950 p-8 text-zinc-100">
      <Stack gap={8}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <Badge className="border-indigo-500/30 bg-indigo-500/10 font-mono text-[10px] text-indigo-400">
                    3-LAYER RISK ENGINE
                  </Badge>
                </div>
        ...
        {/* ERROR BOX */}
        {errorMessage && (
          <div className="flex items-center gap-2 rounded-xl border border-rose-500/20 bg-rose-500/10 p-4 text-xs text-rose-400">
              ...
              <CardContent className="flex flex-wrap items-center justify-between gap-4 p-4">
                ...
                >
                  ...
                  <input
                    ...
                    className="rounded border border-zinc-800 bg-zinc-950 p-1 text-xs text-zinc-400"
                  />
                  <Button
                    type="submit"
                    disabled={isAssessing || !assessFile}
                    className="h-8 bg-indigo-600 px-3 text-xs font-bold text-white hover:bg-indigo-700"
                  >
                ...
                <Button
                  ...
                  variant="secondary"
                  size="sm"
                  className="h-8 border-zinc-800 bg-zinc-900 text-xs font-semibold text-zinc-300"
                >
              ...
              <div className="flex items-center justify-between">
                ...
                {selectedProjectId && (
                  <Button
                    ...
                    variant="secondary"
                    size="sm"
                    className="h-8 border-zinc-800 bg-zinc-900"
                  >
                ...
                <div className="flex flex-col gap-4">
                  {comparisons.map((c) => (
                    ...
                    >
                      ...
                      <ChevronRight className="size-4 text-zinc-400 group-hover:text-indigo-400" />
                    </Link>
                  ))}
                </div>
              )}
                  ...
                  <form onSubmit={handleCreateProject}>
                    <Stack gap={4}>
                      ...
                      <Button
                        ...
                        className="h-10 bg-indigo-600 text-xs font-semibold text-white uppercase"
                      >
                  ...
                  <CardContent className="p-6">
                    <form onSubmit={handleUploadSubmit}>
                      <Stack gap={4}>
                        ...
                        <div className="flex flex-col gap-2">
                          <label className="text-xs text-zinc-400">Upload Revision B</label>
                          <input
                            type="file"
                            required
