      ...
      <Stack gap={6}>
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2 text-xs text-slate-500">
            <span>Dashboard</span>
            <span>/</span>
            <span className="font-medium text-slate-800">Expertise Ledger</span>
          </div>
              ...
              <div className="flex flex-col gap-4">
                {logs.map((l) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                          <span className="text-xs font-bold text-slate-900">{l.operatorName}</span>
                    ...
                    <div className="text-slate-605 flex items-start gap-2 rounded-lg border border-slate-100 bg-slate-50 p-3 text-xs italic">
