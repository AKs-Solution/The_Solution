  ...
  return (
    <MarketingShell>
      ...
      <div className="relative px-6">
        ...
        <section id="workflow" className="mx-auto max-w-6xl scroll-mt-24 py-20">
        ...
        <section id="capabilities" className="mx-auto max-w-6xl scroll-mt-24 pb-20">
          <h2 className="text-center text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            Core capabilities
          </h2>
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
            {CAPABILITIES.map((item) => (
              <article
                key={item.title}
                className="rounded-lg border border-slate-200 bg-white p-6 shadow-xs"
              >
        ...
        <section id="compliance" className="mx-auto max-w-5xl scroll-mt-24 pb-20">
          <h2 className="text-center text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            Compliance mapping
          </h2>
          <p className="mx-auto mt-3 max-w-2xl text-center text-sm leading-relaxed text-slate-500">
        ...
        <section id="use-cases" className="mx-auto max-w-5xl scroll-mt-24 pb-20">
          <h2 className="text-center text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            Use cases
          </h2>
        ...
        <section id="faq" className="mx-auto max-w-3xl scroll-mt-24 pb-8">
          <h2 className="mb-8 text-center text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            Frequently asked questions
          </h2>
          <MarketingFaq />
          <p className="mt-12 text-center font-mono text-xs text-slate-500">{FRESHNESS_LINE}</p>
        </section>
